...
The dataset used is State County. While reading in the data, it was also cleaned by removing the first few rows and last few rows which had unnecessary text. Since the country Canada was also present in the dataset but is a different country, it has been removed as well.
